...
const ChatBot = () => {
    ...
    useEffect(() => {
        const fetchSessionHistory = async () => {
            try {
                const response = await axios.get(`${API_BASE_URL}/session/history`, { withCredentials: true });
    ...
    const resetSession = async () => {
        ...
        try {
            ...
            await axios.get(`${API_BASE_URL}/session/clear-history`, { withCredentials: true });
